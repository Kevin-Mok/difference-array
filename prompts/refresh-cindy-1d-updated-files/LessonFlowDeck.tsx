...
function ProblemMetadataChips({ problem }: { problem: DifferenceArraysProblem }) {
  return (
    <div className="problem-card__metadata" aria-label="Active problem metadata">
      ...
      {problem.source ? (
        <a
          className="problem-card__action problem-card__action--source"
          href={problem.source.url}
          target="_blank"
          rel="noreferrer"
        >
          Source: {problem.source.label}
        </a>
      ) : null}
    </div>
  );
    ...
    <main className="page">
      ...
      <section className="panel">
        ...
        <p className="section-subtitle">
          Four 1D checkpoints in Cindy&apos;s order: teach the foundation, try population deltas, solve beam coverage, then try sparse meeting-demand deltas.
        </p>
        ...
        <div className="timeline-grid">
          ...
          <article className="timeline-content">
            <header className="detail-card__header">
              ...
              {activeSlide.kind === "problem" && activeProblem ? (
                <ProblemMetadataChips problem={activeProblem} />
              ) : (
                <span className="difficulty-chip difficulty-easy">Teaching step</span>
              )}
            </header>
